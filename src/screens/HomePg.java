...
public final class HomePg extends javax.swing.JFrame {
    ...
    private void handleInputButtonReleased(String inputKey, java.awt.event.MouseEvent evt) {
        ...
        if (inputType == null) {
            return; // Ignora o clique se o mapa global ainda não registrou ou limpou a chave
        }
    ...
    private void setCurrentScene(ScenesEnum scene) {
        ...
        switch (scene) {
            ...
            // case GARAGE_SIMULATION -> {
            //     GarageSimulationScenePanel garagePanel = new GarageSimulationScenePanel();
                
            //     garagePanel.setOnCriticalFailureCallback(() -> pauseBt.doClick());
                
            //     currentScenePanel = garagePanel;
            // }
            case ELEVATOR_SIMULATION -> {
                ElevatorSimulationScenePanel elevatorPanel = new ElevatorSimulationScenePanel();
                elevatorPanel.setOnCriticalFailureCallback(() -> pauseBt.doClick());
                currentScenePanel = elevatorPanel;
            }
        }
